...
#ifndef _THRIFT_TRANSPORT_TIRRSOCKET_H_
#define _THRIFT_TRANSPORT_TIRRSOCKET_H_ 1
 ...
 *
 */
class TIrrSocket : public TServerTransport {
public:
   ...
   */
  TIrrSocket(int port, int sendTimeout, int recvTimeout);
   ...
   * @param port    Port number to bind to
   */
  TIrrSocket(const std::string& address, int port);
   ...
   */
  TIrrSocket(const std::string& path);
...
#endif // #ifndef _THRIFT_TRANSPORT_TIRRSOCKET_H_
